...
function knowledgePointers() {
    ...
    var pointerList = ["what is <<attribute>>", "Tell me about <<aval>>", "How good is <<aval>>", "what are the cons of <<aval>> ?", "what are the pros of <<aval>> ?"];
...
function compareFunctionPointers(sku1, sku2) {
    ...
    var pointerList = ["Give me the highlights of <<sku1>>", "Give me the highlights of <<sku2>>", "Pros of <<sku>>", "Pros of <<sku2>>", "What is the RAM of <<sku>>", "compare camera features of <<sku>> and <<sku2>>", "Expert reviews of <<sku>>", "how good is the camera of <<sku2>>"];
    for (var i = 0; i < pointerList.length; i++) {
        var rand;
...
function attributeValueFunctionPointers(sku) {
    ...
    var pointerList = ["what is <<attribute>> of <<sku>>", "Give me highlights of <<sku>>", "what's the  <<attribute>> of <<sku>> ?", "what are the pros of <<sku>> ?", "what are the <<feature>> specs of <<sku>>", "compare <<sku>> with galaxy s5", "compare <<feature>> specs of <<sku>> and oneplus one"];
...
function specsOfSKUFunctionPointers(sku) {
    ...
    var pointerList = ["Give me models with better <<sku>>", "Give me the highlights of <<sku>>", "Give me pros of <<sku>>", "What is the <<attribute>> of <<sku>>", "compare <<feature>> specs of <<sku>> and oneplus one", "Expert reviews of <<sku>>", "How good is <<aval>>? ", "compare <<sku>> with Moto g3"];
...
//# sourceMappingURL=pointers-compiled.js.map

//# sourceMappingURL=pointers-compiled-compiled.js.map